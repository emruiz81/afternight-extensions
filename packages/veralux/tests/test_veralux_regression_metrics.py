...
GOLDEN_METRICS = {
    ...
    "curves": {
        "shape": (64, 64, 3),
        "min": 0.059999994933605194,
        "max": 0.8597351908683777,
        "mean": 0.2517296075820923,
        "std": 0.12990833818912506,
        "p05": 0.0935288518667221,
        "p50": 0.21938791871070862,
        "p95": 0.4990825355052948,
        "sample_0": 0.07388098537921906,
        "sample_1": 0.47133177518844604,
        "sample_2": 0.21946009993553162,
        "sample_3": 0.5237174034118652,
        "mean_abs_delta": 0.1062232032418251,
    },
    "hypermetric_stretch": {
        "shape": (64, 64, 3),
        "min": 0.0,
    ...
    "nox": {
        "shape": (72, 72, 3),
        "min": 0.0007422970375046134,
        "max": 0.5951904654502869,
        "mean": 0.028339223936200142,
        "std": 0.04608507826924324,
        "p05": 0.0020295085851103067,
        "p50": 0.011596563272178173,
        "p95": 0.12637729942798615,
        "sample_0": 0.008361446671187878,
        "sample_1": 0.1649520993232727,
        "sample_2": 0.013521636836230755,
        "sample_3": 0.016093503683805466,
        "mean_abs_delta": 0.15223172307014465,
    },
    "revela": {
        "shape": (64, 64, 3),
        "min": 0.0,
...
STARCOMPOSER_CV2_GOLDEN_METRICS = {
    "shape": (64, 64, 3),
    "min": -0.019636349752545357,
    "max": 0.6293957829475403,
    "mean": 0.01127436850219965,
    "std": 0.051203612238168716,
    "p05": -0.004078436642885208,
    ...
    "mean_abs_delta": 0.0044944859109818935,
}
